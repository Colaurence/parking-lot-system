...
class UpdateParkingSlot {
  ...
  get rules() {
    ...
    return {
      slot: `required|number|unique:parking_slots,slot,id,${id}`,
  ...
  get messages() {
    return {
      ...
      "slot.unique": "Slot already exist in this parking!",
...
module.exports = UpdateParkingSlot;
